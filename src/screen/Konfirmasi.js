...
const Confirm = ({ navigation, route }) => {
    ...
    const scheduleList = JADWAL.filter(item =>
        item.pelabuhanAwal === data.berangkat &&
        item.pelabuhanAkhir === data.tiba &&
        item.kelas_layanan === data.layan &&
        item.tanggal_masuk === data.tanggal &&
        item.jam_masuk === data.jam);
    ...
    return (
        ...
        <Text>Silakan Transfer Kenomor Rekening</Text>
        <Text>
            1234567890
        </Text>
        <TouchableOpacity
