        ...
        <SafeAreaView style={styles.container}>
            <KeyboardAvoidingView>
                <View style={styles.main}>
                    <Text style={styles.title}>Nyebrang</Text>
                    ...
                    <View style={styles.search}>
                        ...
                        onChangeText={getInput('tiba')}
                        value={text.tiba}
                        />
                    </View>  
                    <Text style={styles.titleForm}>Kelas Layanan</Text>
                    <View style={styles.search}>
                        <Icon name="universal-access" size={20} color='grey' />
                        <TextInput
                        style={styles.input}
                    ...
                    <View style={styles.search}>
                        <Icon name="user-clock" size={20} color='grey' />
                        <TextInput
                        style={styles.input}
                        placeholder="Masukkan Jam Masuk"
                        onChangeText={getInput('jam')}
                        value={text.jam}
                        />
                    </View>
                    <Text></Text>
                    ...
                    <TouchableOpacity
                        style={styles.button}
                        onPress={onSubmit}>
                        <Text style={styles.buttonText}><Icon style={styles.searchicon} name="search" size={15} color='#fffs'/>Buat Tiket</Text>
                    </TouchableOpacity>
                </View>
